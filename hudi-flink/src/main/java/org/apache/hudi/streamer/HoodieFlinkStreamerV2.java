...
public class HoodieFlinkStreamerV2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // We use checkpoint to trigger write operation, including instant generating and
        // committing,
        ...
        DataStream<HoodieRecord> inputRecords =
                env.addSource(
                                new FlinkKafkaConsumer<>(
                                        cfg.kafkaTopic, new SimpleStringSchema(), props))
        ...
        inputRecords
                .transform(
                        InstantGenerateOperator.NAME,
                        TypeInformation.of(HoodieRecord.class),
                        new InstantGenerateOperator())
                .name("instant_generator")
                .uid("instant_generator_id")

                // Keyby partition path, to avoid multiple subtasks writing to a partition at the
                // same time
                ...
                .transform(
                        KeyedWriteProcessOperator.NAME,
                        TypeInformation.of(
                                new TypeHint<Tuple3<String, List<WriteStatus>, Integer>>() {}),
